...
Onnx::Onnx(const std::string& strModelPath, const int nHeight, const int nWidth) : m_ortEnv(ORT_LOGGING_LEVEL_WARNING, "TransUnet"), m_ortMemInfo(Ort::MemoryInfo::CreateCpu(OrtArenaAllocator, OrtMemTypeDefault))
{
...
std::array<int64_t, 4> Onnx::vecReturnInputShape() const
{
    return m_aInputShape;
}

std::vector<int64_t> Onnx::vecReturnOutputShape() const
{
    return m_shapeOutputShape;
}

int Onnx::nReturnClassNum() const
{
