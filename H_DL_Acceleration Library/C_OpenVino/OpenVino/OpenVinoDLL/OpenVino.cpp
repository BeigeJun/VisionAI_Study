...
OpenVino::OpenVino(const std::string& strModelPath, const std::string& strDevice, const int nHeight, const int nWidth)
{
...
std::vector<size_t> OpenVino::vecReturnInputShape() const
{
    return m_shapeInputShape;
}

std::vector<size_t> OpenVino::vecReturnOutputShape() const
{
    return m_shapeOutputShape;
}

int OpenVino::nReturnClassNum() const
{
